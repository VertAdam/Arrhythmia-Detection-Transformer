...
def main(learning_rate=0.0001, batch_size=512, epochs=50, model_type='ResNetTransformer'):
	...
	if model_type == 'Transformer_no_PE':
		model = models.Transformer_no_PE()
	...
	for t in range(epochs):
		...
		print(f"Epoch {t+1}\n-------------------------------")
		train_accuracy, train_loss = utils.train_loop(train_loader, model, loss_fn, optimizer, device)
